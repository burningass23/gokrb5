...
func getChallengeReference() *WrapTokenV1 {
...
func getChallengeReferenceNoChksum() *WrapTokenV1 {
	c := getChallengeReference()
	c.CheckSum = nil
	return c
}

func getResponseReference() *WrapTokenV1 {
...
func getResponseReferenceNoChkSum() *WrapTokenV1 {
...
func TestNewInitiatorTokenSignatureAndMarshalling(t *testing.T) {
	t.Parallel()
	token, tErr := NewInitiatorWrapTokenV1([]byte{0x01, 0x01, 0x00, 0x00}, getSessionKey())
